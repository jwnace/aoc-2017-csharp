...
// stopwatch.Start();
// var day25Part1 = Day25.Part1();
// stopwatch.Stop();
// Console.WriteLine($"Day 25, Part 1 took {stopwatch.Elapsed} to run => {day25Part1}");
// stopwatch.Reset();

// stopwatch.Start();
// var day25Part2 = Day25.Part2();
// stopwatch.Stop();
// Console.WriteLine($"Day 25, Part 2 took {stopwatch.Elapsed} to run => {day25Part2}");
// stopwatch.Reset();
